...
class AuthApi {
  ...
  Future<Response<void>> authControllerDevLogin({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerFinalizeTelegramLogin({ 
    required TelegramFinalizeRequest telegramFinalizeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/telegram/finalize';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TelegramFinalizeRequest);
      _bodyData = _serializers.serialize(telegramFinalizeRequest, specifiedType: _type);
  ...
  Future<Response<void>> authControllerSendOtp({ 
    ...
    try {
      const _type = FullType(SendOtpRequest);
      _bodyData = _serializers.serialize(sendOtpRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerTelegramInit({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerTelegramVerify({ 
    required TelegramVerifyRequest telegramVerifyRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/telegram/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TelegramVerifyRequest);
      _bodyData = _serializers.serialize(telegramVerifyRequest, specifiedType: _type);
