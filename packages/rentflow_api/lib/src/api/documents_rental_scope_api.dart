...
class DocumentsRentalScopeApi {

  final Dio _dio;

  final Serializers _serializers;

  const DocumentsRentalScopeApi(this._dio, this._serializers);
  ...
  Future<Response<ListDocumentsResponse>> rentalDocumentsControllerListRentalDocuments({ 
    ...
    final _path = r'/rent/{rentalId}/documents'.replaceAll('{' r'rentalId' '}', encodeQueryParameter(_serializers, rentalId, const FullType(String)).toString());
