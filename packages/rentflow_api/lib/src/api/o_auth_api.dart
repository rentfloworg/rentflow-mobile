...
class OAuthApi {
  ...
  Future<Response<void>> oAuthControllerAuthorize({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'response_type': encodeQueryParameter(_serializers, responseType, const FullType(String)),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oAuthControllerCreateAuthorization({ 
    required CreateAuthorizationRequest createAuthorizationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateAuthorizationRequest);
      _bodyData = _serializers.serialize(createAuthorizationRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oAuthControllerCreateSession({ 
    required CreateSessionRequest createSessionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSessionRequest);
      _bodyData = _serializers.serialize(createSessionRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oAuthControllerExchangeToken({ 
    required ExchangeTokenRequest exchangeTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ExchangeTokenRequest);
      _bodyData = _serializers.serialize(exchangeTokenRequest, specifiedType: _type);
