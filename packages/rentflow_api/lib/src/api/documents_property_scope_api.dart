...
class DocumentsPropertyScopeApi {

  final Dio _dio;

  final Serializers _serializers;

  const DocumentsPropertyScopeApi(this._dio, this._serializers);
  ...
  Future<Response<ListDocumentsResponse>> propertyDocumentsControllerListPropertyDocuments({ 
    required String id,
    String? type,
    String? status,
    ...
    final _path = r'/properties/{id}/documents'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
